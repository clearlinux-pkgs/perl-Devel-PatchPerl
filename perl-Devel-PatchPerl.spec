...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-1.70.tar.gz
...
%prep
%setup -q -n Devel-PatchPerl-1.70
...
cp %{_builddir}/Devel-PatchPerl-1.70/LICENSE %{buildroot}/usr/share/package-licenses/perl-Devel-PatchPerl/6dee1ef2ba9c0f8d0a13d7da54709f8b83f79d3e
if test -f Makefile.PL; then
