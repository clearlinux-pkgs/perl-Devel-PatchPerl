...
%prep
%setup -q -n Devel-PatchPerl-1.80
cd %{_builddir}/Devel-PatchPerl-1.80
...
cp %{_builddir}/Devel-PatchPerl-1.80/LICENSE %{buildroot}/usr/share/package-licenses/perl-Devel-PatchPerl/6dee1ef2ba9c0f8d0a13d7da54709f8b83f79d3e
if test -f Makefile.PL; then
