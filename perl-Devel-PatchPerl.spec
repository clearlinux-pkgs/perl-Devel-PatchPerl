...
Version  : 2.04
Release  : 37
URL      : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-2.04.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-2.04.tar.gz
...
%prep
%setup -q -n Devel-PatchPerl-2.04
cd %{_builddir}/Devel-PatchPerl-2.04
...
cp %{_builddir}/Devel-PatchPerl-2.04/LICENSE %{buildroot}/usr/share/package-licenses/perl-Devel-PatchPerl/6a5761c344378a3eb89978bd318d630f60d30af8
if test -f Makefile.PL; then
