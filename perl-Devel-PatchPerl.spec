...
Version  : 2.06
Release  : 38
URL      : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-2.06.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-2.06.tar.gz
...
%prep
%setup -q -n Devel-PatchPerl-2.06
cd %{_builddir}/Devel-PatchPerl-2.06
...
cp %{_builddir}/Devel-PatchPerl-2.06/LICENSE %{buildroot}/usr/share/package-licenses/perl-Devel-PatchPerl/6a5761c344378a3eb89978bd318d630f60d30af8
if test -f Makefile.PL; then
