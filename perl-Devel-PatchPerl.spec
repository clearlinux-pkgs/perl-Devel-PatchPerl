...
%prep
%setup -q -n Devel-PatchPerl-1.90
cd %{_builddir}/Devel-PatchPerl-1.90
...
cp %{_builddir}/Devel-PatchPerl-1.90/LICENSE %{buildroot}/usr/share/package-licenses/perl-Devel-PatchPerl/6a5761c344378a3eb89978bd318d630f60d30af8
if test -f Makefile.PL; then
