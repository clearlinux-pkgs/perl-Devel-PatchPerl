...
Version  : 1.76
Release  : 21
URL      : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-1.76.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-1.76.tar.gz
...
%prep
%setup -q -n Devel-PatchPerl-1.76
...
cp %{_builddir}/Devel-PatchPerl-1.76/LICENSE %{buildroot}/usr/share/package-licenses/perl-Devel-PatchPerl/6dee1ef2ba9c0f8d0a13d7da54709f8b83f79d3e
if test -f Makefile.PL; then
