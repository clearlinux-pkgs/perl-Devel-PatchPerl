...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/Devel-PatchPerl-1.64.tar.gz
...
%prep
%setup -q -n Devel-PatchPerl-1.64
cd ..
%setup -q -T -D -n Devel-PatchPerl-1.64 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Devel-PatchPerl-1.64/deblicense/
